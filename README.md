...
Design et développement initial de la map : KomponentAB (https://github.com/KomponentAB/Coolio.Town), sous licence CC BY-SA 3.0 (voir LICENSE.map). Ce dépôt en poursuit le développement.
